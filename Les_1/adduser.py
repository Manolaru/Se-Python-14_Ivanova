...
class Adduser(unittest.TestCase):
    ...
    def test_adduser(self):
        ...
        driver.find_element_by_id("password").send_keys("manolaru")
        driver.find_element_by_id("password2").clear()
        driver.find_element_by_id("password2").send_keys("manolaru")
        ...
        driver.find_element_by_id("username").send_keys("manolaru")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("manolaru")
        driver.find_element_by_name("submit").click()
        driver.find_element_by_link_text("Log out").click()
        self.assertRegexpMatches(self.close_alert_and_get_its_text(), r"^Are you sure you want to log out[\s\S]$")
